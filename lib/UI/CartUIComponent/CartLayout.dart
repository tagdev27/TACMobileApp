...
//  GlobalKey cartContainerKey = GlobalKey();
...
//      ..show();
  ...
  addTarget() {
//    targets
//        .add(TargetFocus(identify: "Target 1", keyTarget: cartContainerKey, contents: [
//      ContentTarget(
...
//                  child: Text(
//                    "Swipe to the left to delete items from cart.",
...
//        ));
    ...
    if(items.length > 0){
      int t = ss.getIntItem('toast');
      if(t >= 3){
        return;
      }
      new GeneralUtils().showToast('Swipe to the left to delete items from cart.');
      ss.setIntItem('toast', t+1);
    }
  }
                              ...
                              new IconSlideAction(
                                ...
                                onTap: () {
                                  ...
                                  Scaffold.of(context).showSnackBar(SnackBar(
                                    content: Text("Item Cart Deleted"),
...
//  }
  ...
  void displaySnackBar() {
    Scaffold.of(context).showSnackBar(SnackBar(
      content: Text("Quantity must not be greater than stock"),
      duration: Duration(seconds: 2),
      backgroundColor: Colors.redAccent,
    ));
  }
