...
class ReviewsAll extends StatefulWidget {
  ...
  List<Reviews> mRev;
  double total_rating;
  ReviewsAll(this.total_rating, this.mRev);
                    ...
                    children: <Widget>[
                      Row(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(width: 5.0),
                            Text('${widget.mRev.length} Reviews')
                          ]),
                    ],
                  ),
                ),
...
//                      title: _buildRating(0.0,'18 Nov 2018',
//                          'Item delivered in good condition. I will recommend to other buyer.',
//                              (rating) {
//                            setState(() {
//                              this.rating = rating;
