...
class _profilState extends State<profil> {
  ...
  String _fn, _ln, _email, profile_picture = 'assets/img/womanface.jpg';
  ...
  getUserProfileImage() async {
    DocumentSnapshot user = await Firestore.instance.collection('users').document(_email).get();
  ...
  Widget build(BuildContext context) {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: (profileImageLoaded) ? AssetImage(profile_picture) : NetworkImage(profile_picture))),
            ),
            Padding(
    ...
    return (logged) ? SingleChildScrollView(
      child: Container(
        color: Colors.white,
        child: Stack(
          children: <Widget>[
